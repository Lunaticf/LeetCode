# [leetCode](https://leetcode.com/problemset/algorithms/) ![Language](https://img.shields.io/badge/language-%20Java%20-green.svg) [![License](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE.md) 

Java solutions of Leetcode

[参考题目分类](https://cspiration.com/leetcodeClassification)
...
|697|[Degree of an Array](https://leetcode.com/problems/degree-of-an-array/) | [code](./array/degreeOfArray/DegreeOfArray.java)/[note](array/degreeOfArray/DegreeOfArray.md) | Easy |
...
|38|[Count and Say](https://leetcode.com/problems/count-and-say/) | [code](./string/countAndSay/CountAndSay.java)/[note](string/countAndSay/CountAndSay.md) | Easy |
|58|[Length of Last Word](https://leetcode.com/problems/length-of-last-word/) | [code](./string/lengthOfLastWord/LengthOfLastWord.java)/[note](string/lengthOfLastWord/LengthOfLastWord.md) | Easy |
...
|383|[Ransom Note](https://leetcode.com/problems/ransom-note/) | [code](./string/ransomNote/RansomNote.java)/[note](string/ransomNote/RansomNote.md) | Easy |
|412|[Fizz Buzz](https://leetcode.com/problems/fizz-buzz/) | [code](./string/fizzBuzz/FizzBuzz.java)/[note](string/fizzBuzz/FizzBuzz.md) | Easy |
...
|380|[Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/) | [code](./hashTable/insertDeleteGetRandom/InsertDeleteGetRandom.java)/[note](hashTable/insertDeleteGetRandom/InsertDeleteGetRandom.md) | Medium |
|387|[First Unique Character in a String](https://leetcode.com/problems/first-unique-character-in-a-string/) | [code](./hashTable/firstUniqueCharacterInAString/FirstUniqueCharacterInAString.java)/[note](hashTable/firstUniqueCharacterInAString/FirstUniqueCharacterInAString.md) | Easy |
|389|[Find the Difference](https://leetcode.com/problems/find-the-difference/) | [code](./hashTable/findTheDifference/FindTheDifference.java)/[note](hashTable/findTheDifference/FindTheDifference.md) | Easy |
...
|720|[Longest Word in Dictionary](https://leetcode.com/problems/longest-word-in-dictionary/) | [code](./hashTable/longestWordInDict/LongestWordInDict.java)/[note](hashTable/longestWordInDict/LongestWordInDict.md) | Easy |
...
|108|[Convert Sorted Array to Binary Search Tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/) | [code](./tree/convertSortedArrayToBinarySearchTree/ConvertSortedArrayToBinarySearchTree.java)/[note](tree/convertSortedArrayToBinarySearchTree/ConvertSortedArrayToBinarySearchTree.md) | Easy |
|110|[Balanced Binary Tree](https://leetcode.com/problems/balanced-binary-tree/) | [code](./tree/balancedBinaryTree/BalancedBinaryTree.java)/[note](tree/balancedBinaryTree/BalancedBinaryTree.md) | Easy |
...
|215|[Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/) | [code](./tree/kthLargestElementInAnArray/KthLargestElementInAnArray.java)/[note](tree/kthLargestElementInAnArray/KthLargestElementInAnArray.md) | Medium |
|235|[Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) | [code](./tree/lowestCommonAncestorOfABinarySearchTree/LowestCommonAncestorOfABinarySearchTree.java)/[note](tree/lowestCommonAncestorOfABinarySearchTree/LowestCommonAncestorOfABinarySearchTree.md) | Easy |
